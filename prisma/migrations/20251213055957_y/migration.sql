/*
  ...
  - The values [Intermidiate] on the enum `CourseLevels` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "CourseLevels_new" AS ENUM ('Beginner', 'Intermediate', 'Advances');
